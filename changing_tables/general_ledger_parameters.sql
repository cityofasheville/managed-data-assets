...
-- DROP TABLE internal2.general_ledger_parameters CASCADE;

CREATE TABLE internal2.general_ledger_parameters (
	id int4 NULL,
	parm bpchar(1) NULL,
...
-- DROP TABLE internal2.general_ledger_parameters;
...
AS SELECT general_ledger_parameters.id,
   ...
   FROM internal2.general_ledger_parameters;
...
AS SELECT a.defaultyear,
   ...
   FROM ( SELECT glp1.defaultyear,
           ...
           FROM internal2.general_ledger_parameters glp1) a;
...
AS SELECT a.account_type,
   ...
   FROM ( SELECT m.account_type,
           ...
           FROM simplicity.v_gl_master_mapped m
             LEFT JOIN internal2.general_ledger_parameters glp1 ON 1 = 1
        ...
        UNION ALL
         SELECT b.account_type,
           ...
           FROM simplicity.v_gl_budget_mapped b
             LEFT JOIN internal2.general_ledger_parameters glp2 ON 1 = 1
...
AS SELECT s.department_name,
   ...
   FROM ( SELECT bh.account_type,
          ...
          WHERE NOT ((bh.organization_id::text, bh.object_id::text) IN ( SELECT interfund_transfers.org_code,
                   ...
                   FROM internal2.budget_interfund_transfers interfund_transfers))
