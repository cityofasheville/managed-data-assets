-- internal.coa_districts_public_works definition

-- internal.coa_active_jurisdictions definition

-- Drop table

DROP TABLE internal.coa_active_jurisdictions cascade;

CREATE TABLE internal.coa_active_jurisdictions (
...
CREATE INDEX a31_ix1 ON internal.coa_active_jurisdictions USING gist (shape);
