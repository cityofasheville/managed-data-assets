...
-- DROP TABLE coagis.coa_active_jurisdictions;

CREATE TABLE coagis.coa_active_jurisdictions (
...
CREATE INDEX a259_ix1 ON coagis.coa_active_jurisdictions USING gist (shape);
...
CREATE INDEX a31_ix1 ON coagis.coa_active_jurisdictions USING gist (shape);
